    ...
    <div className="relative min-h-screen w-full bg-black text-white flex items-center justify-center px-4 font-sans overflow-hidden">
      ...
      >
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-2">Nombre del personaje</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-[11px] font-bold uppercase tracking-wider text-gray-400 mb-2">Confirmar</label>
              <input
                type="password"
